...
$(function(){
	...
	$.Validator.match=function(para) {
		...
		var defaultVal = {
			...
			MAIL : "^[0-9a-zA-Z][_.0-9a-z-]{0,31}@([a-zA-Z0-9]+[_|\\_|\\.]?)*[a-zA-Z0-9]+\\.[a-zA-Z]{2,4}$",
            ...
            NUM: "^[3-9]$|^1[0-9]{1}$|^20$",
            ADMINNAME:"^.{2,8}$",
            PAGE_SIZE: "([1234][0-9])|50",
            RED_DES:"^([a-zA-Z0-9\\u4e00-\\u9fa5]{1,10})$",
            RED_PACKET_CUSTOMIZE:"^\\d+(\\.\\d{1,2})?\\:\\d+(\\,\\d+(\\.\\d{1,2})?\\:\\d+)*$"
		};
		var flag=false;
