							...
							'<li>
								<div class="dis-flex">
									...
									<div class="flex-item btn-transfer">
										<span></span>
										<button class="card-single empty-'.$card->cardType.' empty-'.$card->num.'" data-id="'. $card->cardId .'" 
...
<input type="hidden" id="hidden_input_role" value="<?=$role?>">
<input type="hidden" id="role_str" value="<?=$role_str?>" name="role">
