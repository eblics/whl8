...
<head>
    ...
    <script type="text/javascript" src="/static/js/multistrategy_edit.js"></script>
</head>
<body>
    ...
    <div class="main">
        ...
        <div class="rightmain">
            <div class="path">
                <span class="title fleft"><?=$view->title?>叠加策略</span>
            </div>
            <div class="h20"></div>
            <form>
                ...
                <table class="table-form">
                    ...
                    <tr style="background:#eee;">
                        ...
                        <td style="display:none" class="tip center"><b style="color:#333">子策略权重</b></td>
                        <td></td>
                    </tr>
                    <?php
                    foreach ($data->sonlist as $k => $v) {
                        ...
                        <tr class="trlist" style="background:#f5f5f5;">
                            ...
                            <td style="display:none" class="tip"><input class="input center" style="width:100px;" id="weight_'.$k.'" name="weight" value="'.$v->weight.'" valType="NUMBER" msg="<font color=red>*</font>请填写大于0的整数，若为0将不匹配这条子策略" title="请填写大于0的整数，若为0将不匹配这条子策略"/> 填写整数</td>
