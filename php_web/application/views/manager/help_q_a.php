...
可以看到整个涉及到资金的过程中，资金并没有流入到红码平台中。而发放红包的各种信息，都可以在微信支付平台中查询到的。微信支付平台是专业的第三方支付平台，安全系数还是一流的。所以不必太多担心。
                    </div>
                ...
                <div class="paragraph">答：当消费者关注了企业的公众号，扫描我们二维码时，我们就可以在红码平台中查看到该消费者的信息。之后，如果消费者的微信信息被自己修改过了。那么下次该消费者点击“我的账户”，系统将重新获取他的微信信息，来保证消费者信息的“新鲜度”。
                ...
                <div class="paragraph h5">问：微信公众号已经授权给红码平台了，那我们如何使用自动回复功能？</div>
