...
<script type="text/javascript" src="/static/js/batch_order_out_lists.js"></script>
...
<div class="main">
    ...
    <div class="rightmain">
        <div class="path">
            <span class="title fleft">出库单管理</span>
        </div>
        <div class="h20"></div>
        <div class="content">
            ...
            <a id="btnAdd" class="btn btn-blue noselect" href="/batch/order_out_add">增加出库单</a>
        </div>
    </div>
</div>
