...
<script type="text/javascript" src="/static/js/charts_business.js"></script>
...
<div class="main">
    ...
    <div class="rightmain">
        <div class="path">
            <span class="title fleft">业务分析统计</span>
        </div>
        <div class="h30"></div>
        <div class="container">
      ...
      <div class="rptcontent">
          ...
          <div class="content">
            ...
            <div class="content">
            <table id="business_data" class="table">
               <thead>
                    <tr>
                        <th>日期</th>
                        <th>扫码次数</th>
