            ...
            <div class="search-type">
                ...
                <div class="ct2">
                    <select id="s-type">
                        ...
                        <option value="2">企业userId</option>
                        <option value="3">企业nickName</option>
                        <option value="4">系统openid</option>
                        <option value="5">系统userId</option>
                        <option value="6">系统nickName</option>
                    </select>
                </div>
                <div class="ct3">
