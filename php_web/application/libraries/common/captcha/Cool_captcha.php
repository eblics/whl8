...
class Cool_captcha {
     ...
     *
     */
    public $resourcesPath = 'cool_captcha_resources';
    ...
    public $session_var = 'cool_captcha';
    ...
    function GetDictionaryCaptchaText($extended = false) {
        ...
        if (substr($this->wordsFile, 0, 1) == '/') {
            ...
            $wordsfile = dirname(__FILE__).'/'.$this->resourcesPath.'/'.$this->wordsFile;
        }
     ...
     * validate
     */
    public function validate($chastr) {
        $session_var=$this->CI->session->userdata($this->session_var);
        if(strtolower($session_var)==strtolower($chastr)){
            return true;
        }else{
            return false;
        }
